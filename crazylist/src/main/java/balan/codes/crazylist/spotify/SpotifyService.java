...
//
//    private static Map<String, Date> recordProcessingMap = new HashMap<>();
...
//            if(recordProcessingMap.get(userId).after(new Date())){
//                return "Still processing previous Request";
//            }
//            return "Fail Processing previous Request";
//        }
//
...
//        recordProcessingMap.put(userId, new Date(new Date().getTime() + ESTIMATED_PER_MUSIC * nonDuplicatedTrackList.size()));
//
